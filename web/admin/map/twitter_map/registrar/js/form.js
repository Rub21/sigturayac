$(function() {
    ...
    $('form').attr('action', 'https://docs.google.com/a/developmentseed.org/spreadsheet/formResponse?formkey=dFEwQXVWNFdRLXdJZVcwamlUWDRvemc6MA&amp;ifq');
    $("#entry_1").attr('readonly', 'readonly');
    $("#entry_2").attr('readonly', 'readonly');
    $("#entry_5").attr('readonly', 'readonly');
    $("#entry_6").attr('readonly', 'readonly');
    $("#entry_14").attr('readonly', 'readonly');
    $("#entry_13").attr('readonly', 'readonly');
});
